...
<!----------------------------------------------------------chapter 17----------------------------------------------------------------------->
## intent:ImageWorks_desktop
- ImageWorks desktop
- how to open ImageWorks
- Open ImageWorks
- take me to ImageWorks desktop
- steps to open ImageWorks desktop
- what are various sections in the ImageWorks
- what are the components of ImageWorks
- what is displayed after ImageWorks is opened
- list all the options in ImageWorks
- various options of imageworks
- icons in imageworks desktop
- Patient List controls

## intent:ImageWorks_source_menu
- tell me about source menu
- what can source menu do
- various icons of source menu
- what does source menu control
- description on archive device
- what is Network node
- what does CD/DVD indicate
- icon for network node
- what should i press for archive device

## intent:ImageWorks_filter_menu_and_refresh
- ImageWorks filter menu and refresh
- what are the icons in Imagework filter menu
- what does filter menu do
- what  is an eraser in the filter menu
- icon for filter
- what should i press for eraser
- i want to filter data
- what is the icon for refresh
- i want to refresh imageworks

## intent:ImageWorks_patient_list
- what are the information contained in the patient list
- ImageWorks patient list
- what are the exam area options in imageworks
- what is in series options
- what does image options contain
- imageworks information
- what does imageworks patient list contain
- what is in the patient list of the imageworks
- what does the option patient list has


## intent:destinations_options
- What are destinations
- What is the use of destination
- How destination can be  used
- What is archive destination
- What does the destination icon displays
- How to use destination icon
 
## intent:job_management
- How to view jobs in the queue
- What is job management
- Options in job management
- Use of data apps option in job management
- How to open tools menu in job management
- How to display messages related to archive, network, and image
- Job management
 
## intent:job_management_screen
- Open job management  screen
- Options available in job management screen
- What is ShowJobs
- How to view the job history in job management screen
- How to pause the queue in job management screen
- Use of job management screen
- Where completed jobs are displayed
 
## intent:patient_list
- Patient list use
- Series type in patient list
- Use of comb in patient list
- Use of save in patient list
- What is gsps in patient list
- How to use patient list
 
## intent:filter_data_screen
- Open filter data screen
- Use of available filter option in filter data screen
- Use of filter data screen
- What is available filter in filter data screen
- Use of filter field option in filter data screen
- Steps to open filter data screen
 
## intents:add_filter
- steps to add a filter to the Available Filters
- How to add filter to available filter
- Where is the remote host option
- How to save a filter
- Where to enter the filter name
- Create a new filter to available filter
 
## intent:filter_the_list
- Steps to filter the list
- How to filter the list
- Where is the filter list option
- How to use filter list option
- Filter the list
- What does the filter the list option do
 
## intent:remove_a_filter
- Steps to remove a patient filter
- Remove patient filter
- How to remove a patient filter
- Where is the remove patient filter option
- Where is the remove patient filter option available
- What does the remove filter icon do
 
## intent:refresh_database
- Steps to update patient list
- How to update patient list
- Where is the refresh icon in the update patient list option
- Use of update patient list
- Use of refresh icon in the update patient list
- What does the refresh database icon do
 
## intent:find_an_exam
- How to find an exam
- Find exam using exam number
- Steps to find an exam
- What happens if the exam is not in the database
- What is find an exam
- Where to type exam number
 
## intent:remove_exam_or_series
- Remove exam from patient list
- Remove series from patient list
- Remove image from patient list
- Steps to remove exam or series or image from patient list
- How to remove an exam from patient list
- How to remove an image from patient list
- How to remove an series from patient list
 
## intent:sort_patient_list
- Sort data in patient list
- How to sort data in patient list
- Steps to sort data in patient list
- Arrange patient list in ascending order
- Sort patient in descending order
- How to sort the patient list alphabetically
- Methods to sort patient list
 
## intent:sort_series_numerically
- How to sort the series numerically in patient list
- Where is the series sort configuration option
- Example for numerically sorting the series
- Steps to sort series numerically in the patient list
- What is sorting series numerically means
- Series sort series numerically in patient list
 
## intent:resize_exam
- How to resize area in patient list
- Resize exam area in patient list
- Resize series area in patient list
- Resize  image area in patient list
- Steps to size the exam area in patient list
- Steps to size the series area in patient list
- Steps to size the image area in patient list
 
## intent:adjust_images
- Steps to adjust the image  in patient list
- How to adjust the image in patient list
- How to adjust W/L of image in patient list
- How to adjust magnification of the image in patient list
- Steps to zoom the image in patient list
- Steps to scroll the image in patient list
- Zoom the image in patient list
- Scroll the image in patient list
- How can the image in patient list be adjusted
- Types of adjustments can be made in image in patient list
 
## intent:keyboard_patient_list
- What are the shortcut keys used in patient list
- Keyboard shortcuts in patient list
- Use of delete key in patient list
- Use of ctrl key in patient list
- Use of shift key in patient list
- Use of shortcut keys in patient list
<!---------------------------------------------------------chapter 18------------------------------------------------------------->
